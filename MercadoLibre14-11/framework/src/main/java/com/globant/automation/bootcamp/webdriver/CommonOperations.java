...
public abstract class CommonOperations {
	...
	new FluentWait<>(getDriver()).withTimeout(100, SECONDS).pollingEvery(1, SECONDS)
		.ignoring(NoSuchElementException.class).ignoring(StaleElementReferenceException.class).until(condition);
    }

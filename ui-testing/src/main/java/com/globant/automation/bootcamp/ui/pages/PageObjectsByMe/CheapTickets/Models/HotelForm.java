package com.globant.automation.bootcamp.ui.pages.PageObjectsByMe.CheapTickets.Models;
...
public final class HotelForm {
    ...
    private HotelForm(String destination, int checkIn, int checkOut, int rooms, int adults, int children) {
    ...
    public static final class Builder {
        ...
        public static Builder aHotelCriteria() {
            return new Builder();
        }
        ...
        public HotelForm build() {
            return new HotelForm(destination, checkIn, checkOut, rooms, adults, children);
        }
    }
}
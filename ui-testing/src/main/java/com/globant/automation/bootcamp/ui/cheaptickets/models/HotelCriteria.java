...
public final class HotelCriteria {
    ...
    private HotelCriteria(String destination, int checkIn, int checkOut, int rooms, int adults, int children) {
    ...
    public static final class Builder {
        ...
        public HotelCriteria build() {
            return new HotelCriteria(destination, checkIn, checkOut, rooms, adults, children);
        }
    }
}
